...
const FRONT_IMG_FOCUS = {
  scale: 0.7,        // < 1 zooms out, > 1 zooms in
  x: '50%',
  y: '50%',
...
interface ImgFocus { scale: number; x: string; y: string; objectFit?: string }
  ...
  return (
    <div className="configurator">
      <header className="configurator-header">
        <h1>Configurator</h1>
        <p className="configurator-subtitle">Select your collection options below — each choice filters the available options downstream.</p>
      </header>
        ...
        <div>
          ...
          <footer className="configurator-summary">
            ...
            <dl className="summary-grid">
              ...
              <dt>Front</dt><dd>{activeFront || '—'}</dd>
              <dt>Exterior</dt><dd>{activeFinishExt || '—'}</dd>
              <dt>Interior</dt><dd>{activeFinishInt || '—'}</dd>
              <dt>Pull</dt><dd>{activePull || '—'}</dd>
            </dl>
          </footer>
        </div>
